...
const testimonials = [
  {
    ...
    company: "Disney",
    content:
      "Som marknadschef letade jag efter en lösning för att generera fler kvalificerade leads. Med detta team har vi ökat våra försäljningsresultat markant på kort tid.",
    categories: [1, 3, 5],
  },
  {
    ...
    company: "Samsung",
    content:
      "Vi har samarbetat med flera byråer, men detta team har levererat exceptionella resultat. De förstår vår målgrupp och hjälper oss att omvandla leads till kunder effektivt.",
    categories: [1, 2, 4],
  },
  {
    ...
    company: "Rio",
    content:
      "Lead generation brukade vara en flaskhals för oss, men med detta team har vi kunnat skala upp utan problem. Vi har sett en konstant tillväxt av kvalificerade leads.",
    categories: [1, 2, 5],
  },
  {
    ...
    company: "Canon",
    content:
      "Kvaliteten på de leads vi får är över förväntan. Detta team har hjälpt oss att nå nya nivåer av framgång inom vår marknadsföring.",
    categories: [1, 4],
  },
  {
    ...
    company: "Cadbury",
    content:
      "Denna byrå har varit en ovärderlig tillgång för vår marknadsföring. De hjälper oss att snabbt generera kvalificerade leads för flera klienter samtidigt.",
    categories: [1, 3, 5],
  },
  {
    ...
    company: "Maffell",
    content:
      "Jag är imponerad över hur effektivt detta team arbetar. Deras strategiska lead generation har hjälpt oss att förbättra vår närvaro på marknaden.",
    categories: [1, 3],
  },
  {
    ...
    company: "Binance",
    content:
      "Jag blev överraskad över hur enkelt och snabbt vi kunde sätta upp effektiva kampanjer med detta team. Resultaten talar för sig själva.",
    categories: [1, 2, 5],
  },
  {
    ...
    company: "Forbes Inc.",
    content:
      "Detta team erbjuder en enkel och effektiv lösning för att hantera lead generation, vilket har gjort vårt marknadsföringsarbete mycket mer organiserat.",
    categories: [1, 4],
  },
  {
    ...
    company: "Ray Ban",
    content:
      "Att samarbeta med denna byrå har överträffat mina förväntningar. Vi har snabbt kunnat generera leads utan att behöva lägga ner mycket tekniskt arbete.",
    categories: [1, 2],
  },
];
      ...
      <div className="border-t py-12 [border-image:linear-gradient(to_right,transparent,theme(colors.slate.400/.25),transparent)1] md:py-20">
        ...
        <div className="mx-auto max-w-3xl pb-12 text-center">
          ...
          <p className="text-lg text-indigo-200/65">
            Vi erbjuder innovativa marknadsföringslösningar som hjälper företag
            att generera kvalificerade leads och öka sina försäljningsresultat.
          </p>
        </div>
